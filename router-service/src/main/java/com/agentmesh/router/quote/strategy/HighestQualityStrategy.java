...
@Component
public class HighestQualityStrategy implements SelectionStrategy {
    ...
    public List<AgentQuoteResponse> rankAgents(List<AgentQuoteResponse> quotes, ScoringEngine scoringEngine, ScoringEngine.Weights customWeights) {
        ...
        ScoringEngine.Weights qualityWeights = new ScoringEngine.Weights(0.50, 0.25, 0.25, 0.0, 0.0, 0.0);
        for (AgentQuoteResponse quote : validQuotes) {
            double score = scoringEngine.calculateScore(quote, validQuotes, qualityWeights);
